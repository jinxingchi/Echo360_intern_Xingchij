...
public class MongoDBConnection implements DBConnection{
	...
	public Set<String> getVisitedRestaurants(String userId) {
		...
		// iterable every object is a document (json object)
		FindIterable<Document> iterable = db.getCollection("users").find(
				new Document("user_id", userId));
		// iterable.first() return an entry, see if it contains visited
	...
	//eq: static function; eq  = new document()
	@Override
	...
	// same as MySQLDB. This is an algorithm
	@Override
	...
	// get restaurant by geo location
	// all the same except for storing data
	@Override
